  ...
  return (
    <>
      ...
      <div className="flex items-center flex-col flex-grow pt-10 bg-white">
        <div className="px-5">
          <Image src="/assets/main-logo.png" alt="alexandria logo" width="768" height="768" />

          <h1 className="text-center mb-8">
            <span className="hidden text-2xl mb-2">Welcome to</span>
        ...
        <div className="hidden bg-base-300 w-full mt-16 px-8 py-12">
